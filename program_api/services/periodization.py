...
- Undulating periodization: Varying intensity within/across weeks
- Block periodization: Distinct phases (accumulation, transmutation, realization)
- Conjugate periodization: Max effort and dynamic effort rotations
- Reverse linear: Gradual intensity decrease (for endurance/hypertrophy)
"""
...
class WeekParameters:
    ...
    phase: BlockPhase | None = None  # For block periodization
    effort_type: EffortType | None = None  # For conjugate periodization
    ...
    @staticmethod
    def determine_focus(
        intensity_percent: float, is_deload: bool, effort_type: EffortType | None = None
    ) -> TrainingFocus:
        """
...
class PeriodizationService:
    ...
    def calculate_conjugate_progression(
        ...
        - Session 1: Max Effort Upper
        - Session 2: Dynamic Effort Lower
        - Session 3: Repetition Effort (accessories)
        - Session 4: Max Effort Lower / Dynamic Effort Upper
    ...
    def plan_progression(
        ...
        goal: ProgramGoal,
        experience_level: ExperienceLevel,
        model: PeriodizationModel | None = None,
    ) -> List[WeekParameters]:
        """
